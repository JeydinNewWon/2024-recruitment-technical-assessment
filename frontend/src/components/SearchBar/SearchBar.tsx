      ...
      <>
        <div className="flex flex-col justify-center w-full items-center">
          <div className="flex w-5/6 items-center bg-white rounded border-2 border-unilectives-search" onClick={update}>
            ...
            <input type="text" className="cursor-pointer bg-transparent w-full py-2 px-3 text-sm focus:outline-none placeholder-unilectives-search font-medium" autoComplete="off" placeholder="Search for a course e.g. COMP1511" ></input>
          </div>
