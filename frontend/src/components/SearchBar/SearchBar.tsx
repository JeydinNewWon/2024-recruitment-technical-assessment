      ...
      <>
        <div className="flex flex-col justify-center w-full items-center">
          <div className="flex w-5/6 items-center bg-white rounded border-2 border-unilectives-search" onClick={update}>
            ...
            <div className="absolute text-black z-[999] px-4 py-2 bg-white rounded-md border-black border-solid border-2 w-[300px]" style={{display: display, left: 'calc(50vw - 115px)', top: 'calc(50vh - 120px)' }}>
